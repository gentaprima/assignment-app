...
@section('content')
    ...
    <div class="space-y-5 sm:space-y-6">
        ...
        <section
            class="overflow-hidden rounded-2xl bg-gradient-to-br from-red-600 via-red-500 to-orange-400 p-5 text-white shadow-sm sm:rounded-3xl sm:p-6 lg:p-8">
            ...
            <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div
                    class="w-full shrink-0 rounded-2xl border border-white/20 bg-white/10 px-4 py-3 backdrop-blur-sm sm:w-auto">
        ...
        <section class="grid grid-cols-1 gap-5 lg:grid-cols-2">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6">
                ...
                <div class="flex items-start justify-between gap-4">
                    ...
                    @php
                        $todaySchedule = $weeklySchedules->first(function ($schedule) {
                            return $schedule->work_date->isToday();
                        });

                        $isLate = $todaySchedule?->attendance?->status === 'late';
                    @endphp
        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm sm:rounded-3xl">
            ...
            <div
                class="flex flex-col gap-3 border-b border-gray-100 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
