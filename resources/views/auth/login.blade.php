<x-guest-layout>
    ...
    <div class="relative flex h-screen w-full items-center justify-center overflow-hidden bg-gray-50 px-4">
        ...
        <div class="pointer-events-none absolute inset-0 overflow-hidden">
            ...
            <div
                class="absolute -left-32 -top-32 h-80 w-80 rounded-full bg-red-100/70 blur-3xl">
            </div>

            <div
                class="absolute -bottom-32 -right-32 h-80 w-80 rounded-full bg-red-100/70 blur-3xl">
            </div>
        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            {{-- CARD --}}
            <div
                class="rounded-3xl border border-gray-200 bg-white p-6 shadow-xl shadow-gray-200/50 sm:p-8">
